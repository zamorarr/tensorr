...
Let's start with a simple motivating example for sparse tensor usage. Let's say 
...
matrix. A fiber is analgous to a row or column in a 2D matrix in that they are
...
and the matrix. See Kolda and Bader (2009) for more info.
...
## Tensor Multiplication
Tensor multiplication is analagous to matrix multiplication, but is a little 
